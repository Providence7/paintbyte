...
function PortfolioCTA() {
  ...
  return (
    <Link
      ...
      className="flex items-center space-x-2 rounded-full bg-brand px-4 py-3 text-canvas shadow-xl hover:bg-brand-dark transition-all transform hover:scale-105 active:scale-95 focus:outline-none focus:ring-2 focus:ring-brand/50"
    >
      <svg
...
function WhatsAppCTA({ 
  phoneNumber = "2348065704348", 
  defaultMessage = "Hi! I would like to make an inquiry about a painting project." 
}) {
  const location = useLocation()
  ...
  return (
    <a
      ...
      className="flex items-center space-x-2 rounded-full bg-[#25D366] px-4 py-3 text-white shadow-xl hover:bg-[#20ba5a] transition-all transform hover:scale-105 active:scale-95 focus:outline-none focus:ring-2 focus:ring-[#25D366]/50"
    >
      <svg
...
function NotFound() {
  return (
    <section className="mx-auto flex max-w-xl flex-col items-center justify-center px-6 py-24 text-center font-body text-ink">
      ...
      <Link
        to="/"
        className="mt-8 inline-flex items-center justify-center rounded-sm bg-brand px-6 py-3 font-mono text-xs font-medium uppercase tracking-wider text-canvas shadow-sm hover:bg-brand-dark transition-colors focus:outline-none focus:ring-2 focus:ring-brand/40"
      >
        Return to Home Page
      </Link>
    </section>
